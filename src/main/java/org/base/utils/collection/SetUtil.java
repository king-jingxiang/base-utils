package org.base.utils.collection;

import org.base.utils.base.annotation.Nullable;
import org.base.utils.collection.type.ConcurrentHashSet;
...
public class SetUtil {
	 ...
	 * @return
	 */
	public static <E> Set<E> diff(final Set<E> set1,final Set<E> set2){
	 ...
	 * @return
	 */
	public static <E> Set<E> uniq(final Set<E> set1,final Set<E> set2){
		HashSet<E> es = new HashSet<>(set1);
		es.addAll(set2);
		return es;
	}
	 ...
	 * @return
	 */
	public static <E> Set<E> inter(final Set<E> set1,final Set<E> set2){
