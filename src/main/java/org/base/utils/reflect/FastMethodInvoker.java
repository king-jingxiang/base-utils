...
import org.base.utils.base.ExceptionUtil;
import org.base.utils.collection.MapUtil;
import org.base.utils.collection.MapUtil.ValueCreator;
...
public class FastMethodInvoker {
	...
	public static FastMethodInvoker createSetter(final Class<?> clz, final String propertyName,
		...
		if (method == null) {
			throw new IllegalArgumentException(
					"Could not find setter method [" + propertyName + "] on target [" + clz + ']');
		}
		return build(clz, method);
	}
