package org.base.utils.time;

import org.base.utils.base.annotation.NotNull;
...
public class DateUtil {
     ...
     * @return
     */
    public static Date formatDate(Date now) {
     ...
     */
    public static Date getYmd(Date now) throws ParseException {
     ...
     * @throws ParseException
     */
    public static String getSmm() throws ParseException {
        Calendar now = Calendar.getInstance();
        String s = now.get(Calendar.HOUR_OF_DAY) + ":" + now.get(Calendar.MINUTE) + ":" + now.get(Calendar.SECOND);
        return s;
    }
     ...
     * @throws ParseException
     */
    public static Date getNormalTime(String now) throws ParseException {
     ...
     * @throws ParseException
     */
    public static Date getTime(String now) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
        Date date = sdf.parse(now);
        sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String newD = sdf.format(date);
        Date date1 = sdf.parse(newD);
        return date1;
    }
     ...
     * @throws ParseException
     */
    public static Date getDateTime(String now) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        Date date = sdf.parse(now);
        return date;
    }
     ...
     * @throws ParseException
     */
    public static Date getDateTimes(String now) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
        Date date = sdf.parse(now);
        return date;
    }
     ...
     * @return
     */
    public static Date formateDateToPM(Date date) {
        Calendar c = Calendar.getInstance();
        c.setLenient(false);
        c.setTime(date);
     ...
     * @return
     */
    public static Date calcEffectiveDate(int cycle, int value) {
        ...
        switch (cycle) {
            ...
            case 2:
                ...
                c.set(Calendar.DAY_OF_WEEK, (value + 1) % 7);
                if (now.getTime() > c.getTime().getTime()) {
     ...
     * @return days
     */
    public static int getDaysOfDates(Date dt1, Date dt2) {
        return (int) (Math.abs(dt1.getTime() - dt2.getTime()) / 86400000);
    }

    public static Date changeEffectiveDate(Date date, int cycle) {
        switch (cycle) {
            case 1:
